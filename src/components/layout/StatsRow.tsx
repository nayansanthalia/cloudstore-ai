  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mb-4.5">
      ...
      <motion.div
        ...
        className="glass-card rounded-2xl p-4.5 flex flex-col justify-between min-h-[125px] relative overflow-hidden border border-white/50 shadow-sm"
      >
        <div className="flex items-start justify-between">
          <div>
            <span className="text-[11px] font-bold text-brandNavy/65 uppercase tracking-wider">Total Files</span>
            <p className="text-2xs text-brandNavy/50 mt-0.5 font-medium">Increase compared to 6 months earlier</p>
          </div>
          <button className="text-brandNavy/40 hover:text-brandNavy transition-colors p-1 rounded-md hover:bg-slate-100">
            <MoreHorizontal size={14} />
          </button>
        </div>

        <div className="flex items-baseline gap-2 mt-4">
          <span className="text-3xl font-display font-bold text-brandNavy">{totalFiles}</span>
      ...
      >
        <div className="flex items-start justify-between">
          <div>
            <span className="text-[11px] font-bold text-brandNavy/65 uppercase tracking-wider">Storage Index</span>
            <p className="text-2xs text-brandNavy/50 mt-0.5 font-medium">Redundancy reduction optimal</p>
          </div>
          <button className="text-brandNavy/40 hover:text-brandNavy transition-colors p-1 rounded-md hover:bg-slate-100">
            <MoreHorizontal size={14} />
          </button>
        ...
        <div className="flex items-baseline gap-1 mt-4">
          <span className="text-3xl font-display font-bold text-brandNavy">{storage.value}</span>
          <span className="text-sm font-semibold text-brandNavy/65 font-mono ml-0.5">{storage.unit}</span>
          <div className="flex items-center gap-1.5 ml-auto">
      ...
      >
        <div className="flex items-start justify-between">
          <div>
            <span className="text-[11px] font-bold text-brandNavy/65 uppercase tracking-wider">Search Latency</span>
            <p className="text-2xs text-brandNavy/50 mt-0.5 font-medium">Average semantic lookup time</p>
          </div>
          <button className="text-brandNavy/40 hover:text-brandNavy transition-colors p-1 rounded-md hover:bg-slate-100">
            <MoreHorizontal size={14} />
          </button>
        ...
        <div className="flex items-baseline gap-1 mt-4">
          <span className="text-3xl font-display font-bold text-brandNavy">42</span>
          <span className="text-sm font-semibold text-brandNavy/65 font-mono ml-0.5">ms</span>
          <div className="flex items-center gap-1.5 ml-auto">
