...
export const QueryBar = memo(() => {
  ...
  return (
    <div className="w-full shrink-0 px-4 py-3 bg-transparent">
      <div className="max-w-3xl mx-auto flex flex-col gap-3">
        {/* Suggestion Chips (displayed above input) */}
        <div className="flex items-center gap-2 overflow-x-auto pb-0.5 no-scrollbar justify-center">
          <span className="text-2xs text-brandNavy/65 dark:text-slate-400 font-bold shrink-0">Try:</span>
        ...
        <motion.div
          ...
          className={cn(
            'flex items-center gap-3 px-4 rounded-xl shadow-md bg-white/70 border border-white/80 dark:bg-white/5 dark:border-white/10 backdrop-blur-md',
        ...
        >
          ...
          <input
            ...
            placeholder='Ask your storage anything — "Find invoices above ₹10,000"'
